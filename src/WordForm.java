    ...
    public WordForm() {
        ...
        wordButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                // String scan_result = analysis....; //获取删除注释和空格后的代码
                // String partition_result = analysis....; // 获取分割单词的结果
                // String sign_table_result = analysis....; // 获取符号表
                // String error_result = analysis....; //获取错误列表
